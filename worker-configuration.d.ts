...
// Runtime types generated with workerd@1.20251011.0 2025-11-04 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
        // Custom bindings for this project
        readonly PLANET_BASE_URL: string; // e.g. "http://localhost:8086"
        readonly PLANET_AUTH_BASIC: string; // e.g. "Basic xxx"
